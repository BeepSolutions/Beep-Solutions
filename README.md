...
|---|---|
| Method | POST     
| Testing URL| https://api.uat.beep.solutions/transactions
| Production URL| https://api.beep.solutions/transactions
...
|---|---|
| Method | GET     
| Testing URL| https://api.uat.beep.solutions/transactions/<:id>
| Production URL| https://api.beep.solutions/transactions/<:id>
| Headers| Authorization: api_key, Accept: application/json, Content-Type: application/json
| Example| GET https://api.beep.solutions/transactions/5e22e1037ac57f000841efff
...
Sign up with [Beep Plus+](https://beep.solutions) and start accepting Alipay payments for your business today!
